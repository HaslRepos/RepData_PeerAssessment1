...
1. Make a time series plot (e.e. type = "l") of the 5-minute interval (x-axis) and the average 
...
not need to be sophisticated. For example, you yould use the mean/median for that day, or the 
